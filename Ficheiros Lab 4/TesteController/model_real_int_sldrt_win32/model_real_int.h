...
#ifndef RTW_HEADER_model_real_int_h_
#define RTW_HEADER_model_real_int_h_
#include <math.h>
#include <string.h>
#ifndef model_real_int_COMMON_INCLUDES_
# define model_real_int_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* model_real_int_COMMON_INCLUDES_ */

#include "model_real_int_types.h"
...
#define model_real_int_rtModel         RT_MODEL_model_real_int_T
...
#define rtB                            model_real_int_B
#define BlockIO                        B_model_real_int_T
#define rtP                            model_real_int_P
#define Parameters                     P_model_real_int_T
#define rtDWork                        model_real_int_DW
#define D_Work                         DW_model_real_int_T

/* Parameters (auto storage) */
struct P_model_real_int_T_ {
  ...
  real_T Saturation1_LowerSat;         /* Expression: -10
                                        * Referenced by: '<Root>/Saturation1'
                                        */
  real_T DeadZone_Start;               /* Expression: -0.28
                                        * Referenced by: '<Root>/Dead Zone'
                                        */
  real_T DeadZone_End;                 /* Expression: 0.3
                                        * Referenced by: '<Root>/Dead Zone'
                                        */
...
struct tag_RTM_model_real_int_T {
  const char_T *path;
...
extern P_model_real_int_T model_real_int_P;

/* Block signals (auto storage) */
extern B_model_real_int_T model_real_int_B;

/* Block states (auto storage) */
extern DW_model_real_int_T model_real_int_DW;

/* Model entry point functions */
extern void model_real_int_initialize(void);
extern void model_real_int_output(void);
extern void model_real_int_update(void);
extern void model_real_int_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern model_real_int_rtModel *model_real_int(void);
...
extern RT_MODEL_model_real_int_T *const model_real_int_M;
 ...
 *
 * '<Root>' : 'model_real_int'
 * '<S1>'   : 'model_real_int/Observer'
 * '<S2>'   : 'model_real_int/Plant1'
 */
#endif                                 /* RTW_HEADER_model_real_int_h_ */
