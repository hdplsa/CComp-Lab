...
MODEL                := obtervalores
MODULES              := obtervalores_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := obtervalores.mk
...
#
MODELLIB                  := obtervaloreslib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := obtervalores_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/alunos/Desktop/lab/obtervalores_sldrt_win32;C:/Users/alunos/Desktop/lab;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
