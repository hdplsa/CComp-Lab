...
MODEL                := ObterPlant
MODULES              := ObterPlant_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := ObterPlant.mk
...
#
MODELLIB                  := ObterPlantlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ObterPlant_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/FICHEI~1/ObterPlant_sldrt_win32;E:/FICHEI~1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
